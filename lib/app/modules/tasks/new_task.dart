...
class NewTask extends StatefulWidget {
  final int priority;
  const NewTask({Key? key, required this.priority}) : super(key: key);
...
class _NewTaskState extends State<NewTask> {
  ...
  final daysSelected = [false, false, false, false, false, false, false];
  String? repeatString;
  ...
  Widget build(BuildContext context) {
    final project = ctrl.project.value ?? ctrl.defaultProject.value;
    if (widget.priority < 5) {
                ...
                onPressed: () async {
                  ...
                  if (ctrl.taskEditCtrl.text.isNotEmpty) {
                    ...
                    if (added) {
                      ...
                      EasyLoading.showError('Task cannot be created');
                    }
                  }
